...
| Texto do card Revista | A nota pediu: "Em parceria com a Espen e a Dcom, a Onasp lança..." | O texto publicado inicia com "A Ouvidoria lança..." e remove a parceria com Espen e DCOM. | Divergência de conteúdo institucional. | Adotar a redação institucional consolidada posteriormente pela ONASP: `Em articulação com a Espen e a DCOM, esta subpágina reúne referências da Revista Brasileira de Execução Penal.` |
...
| Currículo do Ouvidor | Inserir, abaixo do mapa de localização da homepage, um bloco resumido de contato institucional e, abaixo dele, o currículo do Ouvidor com link para o PDF correspondente. | A página principal ainda não possui essa seção. | Divergência entre a orientação editorial atual e a página publicada/protótipo anterior. | Incluir o bloco de contato resumido e o currículo do Ouvidor na homepage, abaixo do mapa de localização, usando `Documentação/Curriculo_Joao_vitor_elpidio_Ferreira.pdf`. |
