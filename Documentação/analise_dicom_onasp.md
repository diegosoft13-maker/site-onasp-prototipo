...
| Subpáginas temáticas | Criar subpáginas exclusivas para aprofundamento temático, mantendo a página inicial leve. | As subpáginas existem, mas trazem só o parágrafo inicial e a mensagem "Atualmente não existem itens nessa pasta." | Implementação incompleta. O próprio Despacho 566 registrou que permanecia pendente o conteúdo necessário para preenchimento. Também há risco de ruído na redação da Rede de Ouvidorias. | Preparar conteúdo mínimo de cada subpágina antes de nova rodada com a DCOM e substituir o resumo da Rede por linguagem institucional neutra. |
...
7. Quatro cards de subpáginas com nomes aderentes às notas técnicas.
...
- Enviar conteúdo das quatro subpáginas para substituir a mensagem de pasta vazia.
- Confirmar se o card deve se chamar "Ema" ou "Sistema Interamericano de Direitos Humanos".
